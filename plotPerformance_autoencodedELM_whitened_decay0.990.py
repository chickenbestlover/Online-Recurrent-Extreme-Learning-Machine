...
if __name__ == "__main__":
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.99WAOSELM10_pred.csv')
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.99WAOSELM20_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.99WAOSELM25_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.99WAOSELM50_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.99WAOSELM100_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.99WAOSELM200_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.99WAOSELM400_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.99WAOSELM800_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.99WAOSELM1600_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  plt.legend(loc='lower right')
  plt.legend()
  plt.savefig(figPath + 'squrare_deviation_WADOSELM0.990.pdf')
  ...
  plt.savefig(figPath + 'model_performance_summary_WADOSELM0.990.pdf')
