...
if __name__ == "__main__":
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elmA25_pred.csv')
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elmA50_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elmA100_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elmA200_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  #plt.legend()
  plt.savefig(figPath + 'squrare_deviation.pdf')
  ...
  ax1.set_xticklabels( ('basicELM25', 'basicELM50', 'basicELM100', 'basicELM200', 'basicELM400', 'basicELM800', 'basicELM1600' ) )
  ...
  ax3.set_ylabel('MAPE')
  ax3.set_xticklabels(('basicELM25', 'basicELM50', 'basicELM100', 'basicELM200', 'basicELM400', 'basicELM800', 'basicELM1600'))
