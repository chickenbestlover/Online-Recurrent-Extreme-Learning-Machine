...
def initializeELMnet(nDimInput, nDimOutput, numNeurons=10,BN=True, forgettingFactor = 0.99):
...
if __name__ == "__main__":
  ...
  net = initializeELMnet(nDimInput=X.shape[1],
                         nDimOutput=1, numNeurons=1600,BN=True,forgettingFactor =1)
  ...
  saveResultToFile(dataSet, predictedInput, 'Decay'+str(net.forgettingFactor)+'WOSELM'+str(net.numHiddenNeurons))
