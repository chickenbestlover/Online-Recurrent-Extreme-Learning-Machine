...
def initializeREOSELMnet(nDimInput, nDimOutput, numNeurons=10):
  ...
  net = REOSELM(nDimInput, nDimOutput,
...
if __name__ == "__main__":
  ...
  random.seed(6)
  net = initializeREOSELMnet(nDimInput=X.shape[1],
                         nDimOutput=1, numNeurons=1000)
