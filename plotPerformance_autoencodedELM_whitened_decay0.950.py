...
if __name__ == "__main__":
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.95WAOSELM10_pred.csv')
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.95WAOSELM20_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.95WAOSELM25_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.95WAOSELM50_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.95WAOSELM100_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.95WAOSELM200_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.95WAOSELM400_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.95WAOSELM800_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.95WAOSELM1600_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  plt.legend(loc='lower right')
  plt.legend()
  plt.savefig(figPath + 'squrare_deviation_WADOSELM0.950.pdf')
  ...
  plt.savefig(figPath + 'model_performance_summary_WADOSELM0.950.pdf')
