...
if __name__ == "__main__":
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_RecurrentELM_Decay01_Whitened_10_pred.csv')
  ...
  nrmseBasicELM10 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          label='RecurrentELM_#HN=10')
  altMAPEELM10 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_RecurrentELM_Decay01_Whitened_20_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_RecurrentELM_Decay01_Whitened_25_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM25 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='RecurrentELM_#HN=25')
  altMAPEELM25 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_RecurrentELM_Decay01_Whitened_50_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM50 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='RecurrentELM_#HN=50')
  altMAPEELM50 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)


  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_RecurrentELM_Decay01_Whitened_100_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM100 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='RecurrentELM_#HN=100')
  altMAPEELM100 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_RecurrentELM_Decay01_Whitened_200_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM200 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='RecurrentELM_#HN=200')
  altMAPEELM200 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)
  '''
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_RecurrentELM_Decay01_Whitened_400_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM400 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='RecurrentELM_#HN=400')
  altMAPEELM400 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)
  '''

  '''
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay01WAOSELM10_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  plt.legend(loc='lower right')
  plt.legend()
  plt.savefig(figPath + 'squrare_deviation_RecurrentELM_whitened_decay.pdf')
 ...
 # nrmseBasicELM800mean = np.sqrt(np.nanmean(nrmseBasicELM800)) / np.nanstd(truth)
  ...
  ax1.set_xticklabels( ('RecurrentELM10','RecurrentELM20','RecurrentELM23','RecurrentELM25', 'RecurrentELM50', 'RecurrentELM100', 'RecurrentELM200', 'RecurrentELM400', 'RecurrentELM800' ) )
  ...
  ax3.set_ylabel('MAPE')
  ax3.set_xticklabels(('RecurrentELM10','RecurrentELM20','RecurrentELM23','RecurrentELM25', 'RecurrentELM50', 'RecurrentELM100', 'RecurrentELM200', 'RecurrentELM400', 'RecurrentELM800' ))
  ...
  plt.savefig(figPath + 'model_performance_summary_RecurrentELM_whitened_decay.pdf')
