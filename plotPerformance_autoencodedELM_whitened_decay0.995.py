...
if __name__ == "__main__":
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.995WAOSELM10_pred.csv')
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.995WAOSELM20_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.995WAOSELM25_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.995WAOSELM50_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.995WAOSELM100_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.995WAOSELM200_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.995WAOSELM400_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.995WAOSELM800_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  '''
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay0.995WAOSELM1600_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  plt.legend(loc='lower right')
  plt.legend()
  plt.savefig(figPath + 'squrare_deviation_WADOSELM0.995.pdf')
  ...
  ax1.set_xticklabels( ('WAOSELM10','WAOSELM20','WAOSELM25', 'WAOSELM50', 'WAOSELM100', 'WAOSELM200', 'WAOSELM400', 'WAOSELM800','WAOSELM1600' ) )
  ...
  ax3.set_ylabel('MAPE')
  ax3.set_xticklabels(('WAOSELM10','WAOSELM20','WAOSELM25', 'WAOSELM50', 'WAOSELM100', 'WAOSELM200', 'WAOSELM400', 'WAOSELM800', 'WAOSELM1600') )
  ...
  plt.savefig(figPath + 'model_performance_summary_WADOSELM0.995.pdf')
