...
if __name__ == "__main__":
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay1WAOSELM10_pred.csv')
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay1WAOSELM20_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay1WAOSELM25_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay1WAOSELM50_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay1WAOSELM100_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay1WAOSELM200_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay1WAOSELM400_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay1WAOSELM800_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_Decay1WAOSELM1600_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  ...
  plt.legend(loc='lower right')
  plt.legend()
  plt.savefig(figPath + 'squrare_deviation_WAOSELM.pdf')
  ...
  plt.savefig(figPath + 'model_performance_summary_WAOSELM.pdf')
