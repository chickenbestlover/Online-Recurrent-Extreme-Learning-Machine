...
if __name__ == "__main__":
  ...
  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elm10_pred.csv')
  ...
  nrmseBasicELM10 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          label='basicOSELM_#HN=10')
  altMAPEELM10 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elm20_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM20 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='basicOSELM_#HN=20')
  altMAPEELM20 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elm25_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM25 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='basicOSELM_#HN=25')
  altMAPEELM25 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elm50_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM50 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='basicOSELM_#HN=50')
  altMAPEELM50 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elm100_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM100 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='basicOSELM_#HN=100')
  altMAPEELM100 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elm200_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM200 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='basicOSELM_#HN=200')
  altMAPEELM200 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elm400_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM400 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='basicOSELM_#HN=400')
  altMAPEELM400 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elm800_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM800 = plotAccuracy((squareDeviation, xaxisDate),
                          ...
                          window=window,
                          errorType='square_deviation',
                          label='basicOSELM_#HN=800')
  altMAPEELM800 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elm1600_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM1600 = plotAccuracy((squareDeviation, xaxisDate),
                          elmTruth,
                          window=window,
                          errorType='square_deviation',
                          label='basicOSELM_#HN=1600')
  altMAPEELM1600 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)

  (elmTruth, elmPrediction) = loadExperimentResult('./prediction/' + dataSet + '_elm3200_pred.csv')
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseBasicELM1600 = plotAccuracy((squareDeviation, xaxisDate),
                          elmTruth,
  ...
  squareDeviation = computeSquareDeviation(elmPrediction, elmTruth)
  squareDeviation[:skipTrain] = None
  nrmseDecayELM25 = plotAccuracy((squareDeviation, xaxisDate),
                                   elmTruth,
                                   window=window,
                                   errorType='square_deviation',
                                   label='DecayELM_#HN=25')
  altMAPEDecayELM25 = computeAltMAPE(elmTruth, elmPrediction, skipTrain)
  '''
  ...
  #plt.legend()
  plt.savefig(figPath + 'squrare_deviation_basicELM.pdf')
  ...
  nrmseBasicELM1600mean = np.sqrt(np.nanmean(nrmseBasicELM1600)) / np.nanstd(truth)
  ...
  ax1.set_xticklabels( ('basicELM10','basicELM20','basicELM25', 'basicELM50', 'basicELM100', 'basicELM200', 'basicELM400', 'basicELM800', 'basicELM1600' ) )
  ...
  ax3.set_ylabel('MAPE')
  ax3.set_xticklabels(('basicELM10','basicELM20','basicELM25', 'basicELM50', 'basicELM100', 'basicELM200', 'basicELM400', 'basicELM800', 'basicELM1600'))
  ...
  plt.savefig(figPath + 'model_performance_summary_basicELM.pdf')
